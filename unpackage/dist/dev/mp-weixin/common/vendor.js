...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"模板项目","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 5 */
/*!************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/pages.json ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 12 */
/*!*****************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/locale/index.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 13));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 14));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 15));
var _ja = _interopRequireDefault(__webpack_require__(/*! ./ja.json */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
...
/* 13 */
/*!****************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/locale/en.json ***!
  \****************************************************/
/*! exports provided: locale.auto, locale.en, locale.zh-hans, locale.zh-hant, locale.ja, local.title, api.title, index.home, index.my, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"locale.auto\":\"System\",\"locale.en\":\"English\",\"locale.zh-hans\":\"简体中文\",\"locale.zh-hant\":\"繁体中文\",\"locale.ja\":\"日语\",\"local.title\":\"internationalization\",\"api.title\":\"Interface request interceptor\",\"index.home\":\"Home\",\"index.my\":\"My\"}");

/***/ }),
/* 14 */
/*!*********************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/locale/zh-Hans.json ***!
  \*********************************************************/
/*! exports provided: locale.auto, locale.en, locale.zh-hans, locale.zh-hant, local.title, api.title, locale.ja, index.home, index.my, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"locale.auto\":\"系统\",\"locale.en\":\"English\",\"locale.zh-hans\":\"简体中文\",\"locale.zh-hant\":\"繁体中文\",\"local.title\":\"国际化\",\"api.title\":\"接口请求拦截器\",\"locale.ja\":\"日语\",\"index.home\":\"主页\",\"index.my\":\"我的\"}");

/***/ }),
/* 15 */
/*!*********************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/locale/zh-Hant.json ***!
  \*********************************************************/
/*! exports provided: locale.auto, locale.en, locale.zh-hans, locale.zh-hant, locale.ja, local.title, api.title, index.home, index.my, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"locale.auto\":\"系統\",\"locale.en\":\"English\",\"locale.zh-hans\":\"简体中文\",\"locale.zh-hant\":\"繁體中文\",\"locale.ja\":\"日语\",\"local.title\":\"國際化\",\"api.title\":\"介面請求攔截器\",\"index.home\":\"主頁\",\"index.my\":\"我的\"}");

/***/ }),
/* 16 */
/*!****************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/locale/ja.json ***!
  \****************************************************/
/*! exports provided: locale.auto, locale.en, locale.zh-hans, locale.zh-hant, locale.ja, local.title, api.title, index.title, index.home, index.my, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"locale.auto\":\"システム\",\"locale.en\":\"英語\",\"locale.zh-hans\":\"简体中文\",\"locale.zh-hant\":\"繁体中文\",\"locale.ja\":\"日语\",\"local.title\":\"国際化\",\"api.title\":\"インタフェースリクエストブロッキング\",\"index.title\":\"Hello i18n\",\"index.home\":\"ホーム\",\"index.my\":\"ホーム\"}");

/***/ }),
/* 17 */
/*!******************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/utils/request.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _config = __webpack_require__(/*! ./config.js */ 18); // const baseUrl = 'https://2c.mirrorego.com/'
...
{var _ref$method = _ref.method,method = _ref$method === void 0 ? 'GET' : _ref$method,url = _ref.url,_ref$data = _ref.data,data = _ref$data === void 0 ? {} : _ref$data,_ref$header = _ref.header,header = _ref$header === void 0 ? {} : _ref$header;
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      url: url.includes('http') ? url : "".concat(_config.baseRequestDomain).concat(url), //仅为示例，并非真实接口地址。,
      method: method,
      data: data,
      header: header,
      success: function success(res) {var _res$data;
        if (((_res$data = res.data) === null || _res$data === void 0 ? void 0 : _res$data.status) === 200) {
          resolve(res.data);
          return;
        }
        reject(res);
...
uni.$request = request;var _default =
...
/* 18 */
/*!*****************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/utils/config.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.mirroregoImgPath = exports.baseRequestDomain = void 0; // 仅为示例 
// 基地址
var baseRequestDomain = 'https://applet-test.yanghejx.com/gateway/';exports.baseRequestDomain = baseRequestDomain;
var mirroregoImgPath = 'https://union.mirrorego.com/commonmedia/imgs/';

// 仅为示例 资源
exports.mirroregoImgPath = mirroregoImgPath;

/***/ }),
/* 19 */
/*!************************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/mixins/globalMixins.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.globalMixins = void 0;var _config = __webpack_require__(/*! ../utils/config */ 18);
...
var globalMixins = {
  data: function data() {
    return {
      ...
      mirroregoImgPath: _config.mirroregoImgPath, // 示例：image src 使用图片url
...
/* 82 */
/*!*****************************************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/pages.json?{"type":"origin-pages-json"} ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": [{ "path": "pages/index/index", "style": { "navigationBarTitleText": "" } }, { "path": "pages/write/index", "style": { "navigationBarTitleText": "书写任务", "navigationBarBackgroundColor": "#FAF8F7" } }, { "path": "pages/write/writing", "style": { "navigationBarTitleText": "书写任务", "navigationBarBackgroundColor": "#FFFFFF" } }, { "path": "pages/write/write-detail", "style": { "navigationBarTitleText": "书写详情", "navigationBarBackgroundColor": "#FFFFFF" } }, { "path": "pages/write/detail-share", "style": { "navigationBarTitleText": "图片分享", "navigationBarBackgroundColor": "#FFFFFF" } }], "tabBar": { "color": "#7A7E83", "selectedColor": "#007AFF", "borderStyle": "black", "backgroundColor": "#F8F8F8", "list": [{ "pagePath": "pages/index/index", "text": "首页" }, { "pagePath": "pages/write/index", "text": "历史回顾" }] }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" }, "easycom": { "autoscan": true, "custom": { "mirrorego-(.*)": "@/components/mirrorego-$1/index.vue" } }, "condition": { "current": 0, "list": [{ "name": "", "path": "", "query": "" }] } };exports.default = _default;

/***/ }),
/* 83 */
/*!****************************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/pages.json?{"type":"stat"} ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__497041B" };exports.default = _default;

/***/ }),
/* 84 */
/*!**********************************************************************************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/uni_modules/uni-file-picker/components/uni-file-picker/choose-and-upload-file.js ***!
  \**********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js */ 78)["default"]))

/***/ }),
/* 85 */
/*!*****************************************************************************************************!*\
  !*** F:/其他项目/elephant-framework-mp/uni_modules/uni-file-picker/components/uni-file-picker/utils.js ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
